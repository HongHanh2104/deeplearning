...
def space_to_depth_x2(x):
    ...
    # Output: (batch_size, height / block_size, width / block_size, depth * block_size * block_size)
    import tensorflow as tf
...
def yolo_body(inputs, num_anchors, num_classes):
    ...
    # Allow Keras Lambda to use func arguments for output_shape
...
def preprocess_true_boxes(true_boxes, anchors, image_size):
    ...
    # Downsampling factor of 5 x 2-stride max_pools == 32.
